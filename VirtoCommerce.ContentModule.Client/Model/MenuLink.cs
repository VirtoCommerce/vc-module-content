...
namespace VirtoCommerce.ContentModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MenuLink :  IEquatable<MenuLink>
    {
        /// <summary>
        /// Gets or Sets Id
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MenuLink);
        }

        /// <summary>
        /// Returns true if MenuLink instances are equal
        /// </summary>
        /// <param name="other">Instance of MenuLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MenuLink other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
