...
namespace VirtoCommerce.ContentModule.Client.Model
{
    /// <summary>
    /// Represent a summary content statistics
    /// </summary>
    [DataContract]
    public partial class ContentStatistic :  IEquatable<ContentStatistic>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContentStatistic {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ContentStatistic);
        }

        /// <summary>
        /// Returns true if ContentStatistic instances are equal
        /// </summary>
        /// <param name="other">Instance of ContentStatistic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContentStatistic other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
