...
namespace VirtoCommerce.ContentModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MenuLinkList :  IEquatable<MenuLinkList>
    {
        /// <summary>
        /// Gets or Sets Id
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MenuLinkList);
        }

        /// <summary>
        /// Returns true if MenuLinkList instances are equal
        /// </summary>
        /// <param name="other">Instance of MenuLinkList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MenuLinkList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
